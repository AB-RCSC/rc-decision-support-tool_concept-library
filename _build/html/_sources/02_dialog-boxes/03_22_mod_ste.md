...
<img src="../03_images/03_image_files/clarke_et_al_2023_eqn_tte2_ste1.png" class="img_grid"><br><br>The average area of a camera viewshed is calculated using \[this\] equation.
:::::

:::::{grid-item-card} {{ rtxt_moeller_et_al_2018 }}
<img src="../03_images/03_image_files/moeller_et_al_2018_fig3_clipped.png" class="img_grid"><br><br>**Moeller et al. (2018) - Fig. 3** Conceptual diagram of the space to event (STE) model.
:::{dropdown}
...
:::::
:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_fig12_clipped.png" class="img_grid"><br><br>**Clarke et al. (2023) - Fig. 12** One of many time-lapse images taken at a camera station at noon. Notice, the camera trap captures an image at a predetermined time (12:00), regardless of whether an animal is within frame.
:::::

:::::{grid-item-card} {{ rtxt_moeller_et_al_2018 }}
<img src="../03_images/03_image_files/moeller_et_al_2018_fig4_clipped.png" class="img_grid"><br><br>**Moeller et al. (2018) - Fig. 4** Abundance estimates from simulated populations.
:::{dropdown}
...
:::::
:::::{grid-item-card} {{ rtxt_moeller_et_al_2018 }}
<img src="../03_images/03_image_files/moeller_et_al_2018_fig7_clipped.png" class="img_grid"><br><br>**Moeller et al. (2018) - Fig. 7** Factors that influence accurate group counts.
:::{dropdown}
