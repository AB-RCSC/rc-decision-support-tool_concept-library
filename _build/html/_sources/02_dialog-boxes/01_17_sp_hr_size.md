...
<img src="../03_images/03_image_files/00_home_range.jpg" class="img_grid"><br><br>**Home range**: the area within which an animal normally lives and finds what it needs to survive and reproduce.
:::::

:::::{grid-item-card} {{ rtxt_hoeks_et_al_2024 }}
<img src="../03_images/03_image_files/hoeks_et_al_2024_body_mass.png" class="img_grid"><br><br>
:::::

:::::{grid-item-card} {{ rtxt_hoeks_et_al_2024 }}
<img src="../03_images/03_image_files/hoeks_et_al_2024_summary.png" class="img_grid"><br><br>
:::::
