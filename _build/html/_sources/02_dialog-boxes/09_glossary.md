...
[**Camera Active On Arrival*]{#cam_active_on_arrival}
  Whether a camera was functional upon arrival.

[**Camera Active On Departure*]{#cam_active_on_departure}
...
[**Camera Attachment*]{#cam_attachment}
...
[Camera days per camera location]{#cam_days_per_cam_location}
...
[**Camera Direction (degrees)*]{#cam_direction}
...
[**Camera Location Characteristic(s)*]{#cam_location_characteristics}
...
[Capture-recapture (CR) model / Capture-mark-recapture (CMR) model (Karanth, 1995; Karanth & Nichols, 1998)]{#mod_cr_cmr}
...
[Categorical partial identity model (catSPIM) (Augustine et al., 2019; Sun et al., 2022)]{#mod_catspim}
...
[Distance sampling (DS) model (Howe et al., 2017)]{#mod_distance_sampling}
...
[*Easting Camera Location*]{#easting_cam_location}
...
[Hurdle model (Mullahy, 1986; Heilbron 1994)]{#mod_hurdle}
...
[Image classification]{#img_classification}
...
[Image classification confidence]{#img_classification_confidence}
  The likelihood of an image containing an object of a certain class (Fennell et al., 2022).

[**Image Flash Output*]{#img_flash_output}
...
[**Image Infrared Illuminator*]{#img_infrared_illuminator}
...
[Image processing]{#img_processing}
...
[*Image Set End Date Time (DD-MMM-YYYY HH\:MM\:SS)*]{#img_set_end_date_time}
...
[*Image Set Start Date Time (DD-MMM-YYYY HH\:MM\:SS)*]{#img_set_start_date_time}
...
[**Image Trigger Mode*]{#img_trigger_mode}
...
[**Image/Sequence Comments*]{#img_sequence_comments}
  Comments describing additional details about the image/sequence.

[*Image/Sequence Date Time (DD-MMM-YYYY HH\:MM\:SS)*]{#img_sequence_date_time}
...
[Instantaneous sampling (IS) (Moeller et al., 2018)]{#mod_instantaneous_sampling}
...
[Intensity of use (Keim et al., 2019)]{#use_intensity}
...
[*Latitude Camera Location*]{#latitude_cam_location}
...
[*Longitude Camera Location*]{#longitude_cam_location}
...
[Mark-resight (MR) model (Arnason et al., 1991; McClintock et al., 2009)]{#mod_mr}
...
[Model assumption]{#mod_assumption}
...
[Modelling approach]{#mod_approach}
...
[*Northing Camera Location*]{#northing_cam_location}
...
[Occupancy model (MacKenzie et al., 2002)]{#mod_occupancy}
...
[Overdispersion]{#mod_overdispersion}
...
[Poisson regression]{#mod_poisson}
...
[Random encounter and staying time (REST) model (Nakashima et al., 2018)]{#mod_rest}
...
[Random encounter model (REM) (Rowcliffe et al., 2008, 2013)]{#mod_rem}
...
[Relative abundance indices]{#mod_relative_abundance}
...
[Royle-Nichols model (Royle & Nichols, 2003; MacKenzie et al., 2006)]{#mod_royle_nichols}
...
[Space-to-event (STE) model (Moeller et al., 2018)]{#mod_ste}
...
[Spatial count (SC) model / Unmarked spatial capture-recapture (Chandler & Royle, 2013)]{#mod_sc}
...
[Spatial mark-resight (SMR) (Chandler & Royle, 2013; Sollmann et al., 2013a, 2013b)]{#mod_smr}
...
[Spatial partial identity model (2-flank SPIM) (Augustine et al., 2018)]{#mod_2flankspim}
...
[Spatially explicit capture-recapture (SECR) / Spatial capture-recapture (SCR) (Borchers & Efford, 2008; Efford, 2004; Royle & Young, 2008; Royle et al., 2009)]{#mod_scr_secr}
...
[Time in front of the camera (TIFC) (Huggard, 2018; Warbington & Boyce, 2020; tested in Becker et al., 2022)]{#mod_tifc}
...
[Time-to-event (TTE) model (Moeller et al., 2018)]{#mod_tte}
...
[Total number of camera days]{#total_number_of_cam_days}
...
[*UTM Zone Camera Location*]{#utm_zone_cam_location}
...
[Zero-inflated negative binomial (ZINB) regression (McCullagh & Nelder, 1989)]{#mod_zinb}
...
[Zero-inflated Poisson (ZIP) regression (Lambert, 1992)]{#mod_zip}
...
[Zero-inflation]{#mod_zero_inflation}
