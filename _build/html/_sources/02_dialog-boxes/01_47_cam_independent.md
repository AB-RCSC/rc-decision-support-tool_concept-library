...
<img src="../03_images/03_image_files/zuckerberg_et_al_2020_fig1_clipped.png" class="img_grid"><br><br>**Zuckerberg et al. (2020) - Fig. 1** Four experimental designs sampling species occupancy on a theoretical landscape.
:::{dropdown}
...
:::::
:::::{grid-item-card} {{ rtxt_zuckerberg_et_al_2020 }}
<img src="../03_images/03_image_files/zuckerberg_et_al_2020_fig3_clipped.png" class="img_grid"><br><br>**Zuckerberg et al. (2020) - Fig. 3** Four different sampling scenarios superimposed on maps of probability of occurrence aggregated to different scales of resolution to match the corresponding landscape buffer.
:::{dropdown}
...
<img src="../03_images/03_image_files/moqanaki_et_al_2021_fig1_clipped.png" class="img_grid"><br><br>**Moqanaki et al. (2021) - Fig. 1** Examples of spatially variable and autocorrelated baseline detection probability (higher = darker blue shading) in grid of detectors (gray dots) centered in a habitat (entire area surrounded by the blue line with rounded corners).
:::{dropdown}
