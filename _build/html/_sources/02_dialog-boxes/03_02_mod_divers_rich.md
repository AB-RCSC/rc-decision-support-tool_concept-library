...
::::{grid-item-card} {{ ref_intext_styring_2020 }}
<iframe 
    width="300"
    height="200"
...
**iNext Online**
 ...
 Software for interpolation and extrapolation of species diversity Rarefied Species Accumulation Curves (the simple way) tutorial.
