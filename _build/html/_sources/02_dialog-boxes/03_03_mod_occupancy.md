...
**{{ term_mod_occupancy }}**: {{ term_def_occupancy }}
<br>
Add some info here
...
::::::{tab-item} Advanced
<!—refs checked; need fix sollman 2018 -->
...
- Occupancy-abundance relationships appear to be robust to territoriality, grouptravelling behaviour and other biological traits (
...
::::{grid-item-card} {{ ref_intext_chatterhee_et_al_2021 }}
```{figure} ../03_images/03_image_files/chatterhee_et_al_2021_table2.png 
:width: 300px
:align: center
```
figure4_caption
...
```{figure} ../03_images/03_image_files/c……..h 
:width: 300px
:align: center
```
figure5_caption
...
| R code/Tutorial | “An Introduction to Camera Trap Data Management and Analysis in R > Chapter 11 Occupancy” |     |     | {{ ref_bib_resource7_ref_id }} |
::::::
