...
- **{{ term_sp_behav_exploratory }}**: {{ def_sp_behav_exploratory }}
- **{{ term_sp_behav_neutral }}**: {{ def_sp_behav_neutral }}
- **{{ term_sp_behav_unkn }}**: {{ def_sp_behav_unkn }}
- **{{ term_sp_behav_unkn }}**: {{ def_sp_behav_unkn }}
- **{{ term_sp_behav_variable }}**: {{ def_sp_behav_variable }}
::::::::
