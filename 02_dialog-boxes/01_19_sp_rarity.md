...
- **{{ name_ sp_rarity_common }}**: {{ def_sp_rarity_common }}
- **{{ name_sp_rarity_less_common }}**: {{ def_sp_rarity_less_common }}
...
- **{{ name_sp_rarity_multiple}}**: {{ def_sp_rarity_multiple }}
...
<img src="../03_images/03_image_files/leroy_2024_Rarity_cutoff-point.png" class="img_grid"><br><br>**Leroy (2024)** The rarity cut-off point is here defined as the threshold of occurrence below which species are considered rare.
:::::

:::::{grid-item-card} {{ rtxt_leroy_2024 }}
<img src="../03_images/03_image_files/leroy_2024_Weight_assignation-curve.png" class="img_grid"><br><br>**Leroy (2024)** Weight assignation curve adjusted to an arbitrary rarity cut-off.
:::::
