...
<img src="../03_images/03_image_files/murray_et_al_2021.jpg" class="img_grid"><br><br>**Murray et al. (2021) - Fig. 1** Schematic of our multi- state occupancy model to estimate the occurrence of coyotes and mange.
:::{dropdown}
...
<img src="../03_images/03_image_files/southwell_et_al_2019_fig1_clipped.png" class="img_grid"><br><br>**Southwell et al. (2019) - Fig. 1.** Structure of the spatially explicit power analysis framework for multiple species in dynamic landscapes.
:::::

:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_eqn_occupancy1.png" class="img_grid"><br><br>
:::::
...
<img src="../03_images/03_image_files/proteus_2018_obs_state.jpg" class="img_grid"><br><br>
:::::
