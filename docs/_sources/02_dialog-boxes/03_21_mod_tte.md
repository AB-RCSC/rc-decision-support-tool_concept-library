...
<img src="../03_images/03_image_files/clarke_et_al_2023_eqn_tte1.png" class="img_grid"><br><br> **Clarke et al. (2023) - Eqn TTE**:
...
:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_eqn_tte2_ste1.png" class="img_grid"><br><br>**Clarke et al. (2023) - Eqn TTE *𝑎***:The equation for *𝑎* in camera data-based density estimation using TTE (refer to "Clarke et al. (2023) - Eqn TTE").
:::::

:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_fig10_clipped.png" class="img_grid"><br><br>**Clarke et al. (2023) - Fig. 10** Adapted from Moeller et al. (2018). Visualization of how total sampling time at a camera station is broken down into sampling occasions and then sampling periods.
:::::

:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_fig11_clipped.png" class="img_grid"><br><br>**Clarke et al. (2023) - Fig. 11** Simple diagrams showing dispersed, clumped and Poisson-distributed animals (red dots) in space.
:::::

:::::{grid-item-card} {{ rtxt_moeller_lukacs_2021 }}
<img src="../03_images/03_image_files/moeller_lukacs_2021_fig1.png" class="img_grid"><br><br>**Moeller & Lukacs (2021)** The spaceNtime workflow for count data. The user will go through five major steps for STE, TTE, and IS analyses. If the user has presence/absence (0 and 1) data instead of count data, the IS analysis is not appropriate, and the IS pathway should be removed from the flowchart.
:::::

:::::{grid-item-card} {{ rtxt_moeller_et_al_2018 }}
<img src="../03_images/03_image_files/moeller_et_al_2018_fig1_clipped.png" class="img_grid"><br><br>**Moeller et al. (2018) - Fig. 1** Schematic of sampling periods and occasions for the time to event model. At camera *i* = 1, 2, . . ., *M*, sampling occasion *j* = 1, 2, . . ., *J* is broken into several sampling periods *k* = 1, 2, . . ., *K*. Here, *J* = 2 and *K* = 3.
:::::

:::::{grid-item-card} {{ rtxt_moeller_et_al_2018 }}
<img src="../03_images/03_image_files/moeller_et_al_2018_fig2_clipped.png" class="img_grid"><br><br>**Moeller et al. (2018) - Fig. 2** Conceptual diagram of the time to event (TTE) model.
:::{dropdown}
