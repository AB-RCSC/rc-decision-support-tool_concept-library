...
<img src="../03_images/03_image_files/clarke_et_al_2023_eqn_scr1.png" class="img_grid"><br><br>
:::::

:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_fig4_clipped.png" class="img_grid"><br><br>**Clarke et al. (2023) – Fig. 4.** SCR models are made up of two sub-models: an observation model, which describes where individual animals are detected (i.e., their detection histories); and a spatial process model, which describes how animals’ activity centres are distributed.
:::::

:::::{grid-item-card} {{ rtxt_clarke_et_al_2023 }}
<img src="../03_images/03_image_files/clarke_et_al_2023_fig4_clipped.png" class="img_grid"><br><br>**Clarke et al. (2023) - Fig. 5** Adapted from Morin et al., (2022) and Royle et al., (2014). A) A diagram of how the individual activity centres (circles) that make up a population might overlap with a camera array (grey crosses).
:::{dropdown}
...
<img src="../03_images/03_image_files/efford_2024_fig1.png" class="img_grid"><br><br>
:::::

:::::{grid-item-card} {{ rtxt_u_capetown_2017 }}
<img src="../03_images/03_image_files/secr_creemmural_org_secr.png" class="img_grid"><br><br>**University of Cape Town, 2024c - Slide 6** Observation process - The expected frequency of encountering an individual depends
on the individual's location in space.
:::::

:::::{grid-item-card} {{ rtxt_jimenez_et_al_2021 }}
<img src="../03_images/03_image_files/jimenez_et_al_2021_fig1_clipped.png" class="img_grid"><br><br>**Jiménez et al. (2021) - Fig. 1** Graphical depiction of the random thinning spatial capture–recapture model. Random thinning SCR is hierarchical model with two processes: ecological (population size and location—*s*<sub>i</sub>—of individuals) and observation.
:::{dropdown}
