...
# {{ title_i_num_cams }}
::::::::{hint}
If you only have a set number of cameras to deploy (e.g., 30), enter the number of cameras in the numeric field.
...
:::{seealso}
You can refer to **Appendix A - Table A2** below from the {{ link_surv_guide }} to get a sense of the required number of cameras for each of the modelling approaches and according to the {{ survey_objectives_tu }}.
